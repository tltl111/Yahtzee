...
class Bord(Frame):
    def __init__(self, master):
        ...
        self.houvastknop1 = Button(self.knoppenFrame2, text='    -    ', font=('Impact', 20),
        ...
        self.houvastknop2 = Button(self.knoppenFrame2, text='    -    ', font=('Impact', 20),
        ...
        self.houvastknop3 = Button(self.knoppenFrame2, text='    -    ', font=('Impact', 20),
        ...
        self.houvastknop4 = Button(self.knoppenFrame2, text='    -    ', font=('Impact', 20),
        ...
        self.houvastknop5 = Button(self.knoppenFrame2, text='    -    ', font=('Impact', 20),
    ...
    def werpstenen(self, start):
        ...
        if self.animatiesCount == 0:
            ...
            self.houvastknop4.config(state=NORMAL, relief=RAISED)
            self.houvastknop5.config(state=NORMAL, relief=RAISED)
            self.canvas.create_text(210, 490, text="Selecteer hieronder de stenen die je wilt bewaren", font=(
                'Impact', 15))
            return
        else:
            self.canvas.delete("all")
