        ...
        if worp1 == "j":
            ...
            if worp2 == "j":
                ...
                if worp3 == "j":
                    ...
                    worp4 = input("Kun je alle dobbelstenen bewaren? (j/n) ")
                    if worp4 == "j":
                        score = uitslag(gerolde_dobbelstenen3[0])
                    if worp4 == "n":
                        gerolde_dobbelstenen4 = verwijder(gerolde_dobbelstenen3[0])
                        score = uitslag(gerolde_dobbelstenen4[0])
                        print(gerolde_dobbelstenen4[0])
                        break
                if worp3 == "n":
                    gerolde_dobbelstenen3 = verwijder(gerolde_dobbelstenen2[0])
                    score = uitslag(gerolde_dobbelstenen3[0])
                    print(gerolde_dobbelstenen3[0])
                    break
            if worp2 == "n":
                gerolde_dobbelstenen2 = verwijder(gerolde_dobbelstenen1)
                score = uitslag(gerolde_dobbelstenen2[0])
                print(gerolde_dobbelstenen2[0])
                break
            return score
        if worp1 == "n":
...
def wissel(steenlijst):
    valid = True
    wisselsteen = input("Type de positie van de stenen die je wilt wisselen: (1-5): ")
    ...
    while valid == False:
        ...
        print("Foute invoer")
        print("")
        wisselsteen = input(format("Type de positie van de stenen die je wilt wisselen: (1-5): "))
        wisselsteen = wisselsteen.replace(",", "")
        wisselsteen = wisselsteen.replace(" ", "")
        wisselsteenlijst = []
        for x in wisselsteen:
...
def verwijder(steenlijst):
    valid = True
    wisselsteen = input("Type de positie van de stenen die je NIET wilt bewaren: (1-5): ")
    wisselsteen = wisselsteen.replace(",", "")
    wisselsteen = wisselsteen.replace(" ", "")
    wisselsteenlijst = []
    for x in wisselsteen:
    ...
    while valid == False:
        ...
        print("Foute invoer")
        print("")
        wisselsteen = input(format("Type de positie van de stenen die je NIET wilt bewaren: (1-5): "))
        wisselsteen = wisselsteen.replace(",", "")
        wisselsteen = wisselsteen.replace(" ", "")
        wisselsteenlijst = []
        for x in wisselsteen:
