...
class Bord(Frame):
    def __init__(self, master):
        ...
        self.worpButton.grid(row=0, column=0, rowspan=6, sticky='news')
        ...
        for i in self.categorieen:
            ...
            c = Canvas(self.schermFrame, height=60, width=320, bg='green')
            s = Label(self.schermFrame, text='', font=('Impact', 20))
    ...
    def score_spel(self):
        ...
        self.canvas.create_text(200, 50, text="Score: {}".format(totaal), font=('Impact', 50))
